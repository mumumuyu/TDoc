...
```java
		String responseBody = Unirest.post("http://115.236.162.166:18081/smk_distraffic/in/busApp/queryDiscounts")
                        .header("Content-Type", "application/json")
                        .body(bodys)
                        .asString().getBody();
                logger.debug("getLinePlatformPrice getLinePlatformPrice httpResponse responseBody {}", responseBody);
...
//转JSON对象
JSONObject object = JSONObject.parseObject(list);
//获取值
...
//List<T> --> xxx[]
int[] ints1 = lists.stream().mapToInt(Integer::valueOf).toArray();
// String[] --> List<String>
String[] strings = {"0", "1", "2", "3"};
List<String> stringList= Stream.of(strings).collect(Collectors.toList());
// List<String> --> String[]
String[] strings1 = stringList.stream().toArray(String[]::new);
```
